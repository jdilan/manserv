...
================================================================================
Target: SQLite 3
Purpose: Insert sample loan accounts for testing
Converted from: SQL Server 2022 sample data
Date: December 6, 2025

SAMPLE DATA INCLUDES:
- 10 sample loan accounts with various statuses
- Additional test scenarios for edge cases
- Realistic data for demo and testing

USAGE:
sqlite3 manserv_test.db < SQLite_SampleData.sql
================================================================================
*/
...
VALUES (
    ...
    0, NULL, 0, NULL,
    'CUR', 'C', 'PHP', 'Closed',
    0, '2024-12-01', 'SYSTEM', datetime('now')
);
...
-- Test Account 11: Minimum Required Fields Only
INSERT OR IGNORE INTO Account (
    ReferenceNumber, PreviousReferenceNumber, CustomerName, LongName,
    CenterCode, BudgetUnit, Corporation, BookCode, EconomicActivityCode,
    OriginalReleaseDate, StartOfTerm, MaturityDate, AccountType,
    FundSource, LendingProgram, Area, TypeOfCredit, MaturityCode,
    PurposeOfCredit, LoanStatus, LoanProjectType, Currency, Status,
    CreatedBy, CreatedDate
)
VALUES (
    'LA-2025-MIN-001', 'LA-2024-MIN-001', 'Minimal Data Customer', 'Minimal Data Customer Long Name',
    '01', '001', 'RTL', '11', 'IND001',
    '2025-06-01', '2025-06-01', '2030-06-01', 'IND',
    'BSP', 'DBP', 'PA', 'CUR', 'B',
    'P', 'CUR', 'C', 'PHP', 'Active',
    'SYSTEM', datetime('now')
);

-- Test Account 12: Special Characters in Name
INSERT OR IGNORE INTO Account (
    ReferenceNumber, PreviousReferenceNumber, CustomerName, LongName,
    CenterCode, BudgetUnit, Corporation, BookCode, EconomicActivityCode,
    OriginalReleaseDate, StartOfTerm, MaturityDate, AccountType,
...
VALUES (
    'LA-2025-SPEC-001', 'LA-2024-SPEC-001', 'José María Ñ & Co.', 'José María Ñoño & Company, Inc.',
    '01', '001', 'RTL', '11', 'IND001',
    '2025-07-01', '2025-07-01', '2030-07-01', 'IND',
    'BSP', 'DBP', 'PA', 'CUR', 'B',
    'P', 'CUR', 'C', 'PHP', 'Active',
    'SYSTEM', datetime('now')
);
...
INSERT OR IGNORE INTO AccountAudit (
    AccountId, ReferenceNumber, Action, FieldName, OldValue, NewValue,
    ChangedBy, ChangedDate, UserRole, IPAddress, Comments
)
VALUES
    (1, 'LA-2025-0001', 'Create', NULL, NULL, NULL, 'SYSTEM', datetime('now'), 'Administrator', '127.0.0.1', 'Initial account creation'),
    (2, 'LA-2025-0002', 'Create', NULL, NULL, NULL, 'SYSTEM', datetime('now'), 'Administrator', '127.0.0.1', 'Initial account creation'),
    (3, 'LA-2024-0500', 'Update', 'LoanStatus', 'CUR', 'PDO', 'SYSTEM', datetime('now'), 'User', '127.0.0.1', 'Status changed to past due');

-- ============================================================================
-- SAMPLE RELATIONSHIP RECORDS
-- ============================================================================

INSERT OR IGNORE INTO AccountRelationship (
    SourceAccountId, TargetAccountId, RelationshipType, CreatedBy, CreatedDate
)
VALUES
    (1, 4, 'Copy', 'SYSTEM', datetime('now'));
...
-- SELECT Status, COUNT(*) as Count FROM Account GROUP BY Status;
